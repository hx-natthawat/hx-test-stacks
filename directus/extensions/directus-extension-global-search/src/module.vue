...
const indexes: Ref<Record<string, Index>> = ref(
  (GlobalSearchConfig || {}) as Record<string, Index>
);
const searchValue = ref(
  decodeURIComponent(router.currentRoute?.value.hash?.replace("#", "") || "")
);
    ...
    <template #sidebar>
      ...
      >
        ...
        <v-detail label="JSON">
          ...
          <p class="hint">
            Paste this json into the top of the `index.js` file of the
    ...
    <div style="margin: 1rem">
      <v-sheet>
        <div style="width: 300px; margin: 1rem auto">
          ...
          <p
            v-show="isSearching && !status.loading"
            style="color: var(--foreground-subdued)"
          >
